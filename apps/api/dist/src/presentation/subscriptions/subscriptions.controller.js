...
const subscriptions_service_1 = require("../../application/subscriptions/subscriptions.service");
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Listar assinaturas' }),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Buscar assinatura por ID' }),
